...
export function HeroWithImage() {
	...
	return (
		<section className="relative py-20 px-6 overflow-hidden">
			...
			<div className="relative max-w-7xl mx-auto grid grid-cols-2 gap-12">
				<div>
					...
					<p className="text-lg md:text-xl text-gray-300 mb-8 leading-relaxed">
						We analyze your repository, detect languages/frameworks, you assess
						your knowledge and we generate a personalized study plan.
					</p>
