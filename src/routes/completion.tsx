	...
	const completedModules = useMemo(() => {
		...
		return plan.modules
			.map((module, idx) => ({
				...module,
				moduleIndex: idx,
				completedAt: planProgress.find((p) => p.moduleIndex === idx)
					?.completedAt,
			}))
					...
					<div className="max-w-4xl mx-auto">
						...
						<div className="text-center mb-12">
							...
							<p className="text-lg text-gray-300">
								You've successfully finished all {completedModules.length}{" "}
								modules
							</p>
						</div>
						...
						<div className="mt-8 text-center">
							<p className="text-gray-400 text-lg">
								🎯 Keep up the great work! Continue learning and growing your
								skills.
							</p>
						</div>
					</div>
